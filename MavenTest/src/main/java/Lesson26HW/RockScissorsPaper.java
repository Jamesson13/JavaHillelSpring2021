...
public class RockScissorsPaper {
    ...
    public RockScissorsPaper(){
        ...
        uim = ResourceBundle.getBundle("MessagesBundle.GameLocale");
    }

    public RockScissorsPaper(String lang){
        locale = new Locale(lang);
        uim = ResourceBundle.getBundle("MessagesBundle.GameLocale", locale);
    }
